...
![Alt Text](https://github.com/Tiham2001/tarp/blob/main/Images/Sorting%20data%20-%201.png)

![Alt Text](https://github.com/Tiham2001/tarp/blob/main/Images/Sorting%20data%20-%202.png)
...
![Alt Text](https://github.com/Tiham2001/tarp/blob/main/Images/Categorization%20of%20data%20-%201.png)
...
![Alt Text](https://github.com/Tiham2001/tarp/blob/main/Images/Clustering%20of%20data%20-%201.png)
...
![Alt Text](https://github.com/Tiham2001/tarp/blob/main/Images/chain%20creation%20-%201.png)
...
![Alt Text](https://github.com/Tiham2001/tarp/blob/main/Images/Implementation%20-%201.jpg)

![Alt Text](https://github.com/Tiham2001/tarp/blob/main/Images/Implementation%20-%202.jpg.png)

![Alt Text](https://github.com/Tiham2001/tarp/blob/main/Images/Implementation%20-%203.jpg.png)
...
Table 1: Evaluation results for the career path recommendation system

| Metric | Value |
| --- | --- |
| Accuracy	| 80.43% |
| Precision	| 73.23% |
| Testing Recall | 81.07% |
| F1 Score | 76.95% |
| Testing F-Beta | 74.67% |
...
![Alt Text](https://github.com/Tiham2001/tarp/blob/main/Images/WhatsApp%20Image%202023-04-15%20at%2016.47.24.jpeg)
...
One limitation of the system is that it relies heavily on the accuracy and completeness of the user's input. If the user does not provide accurate or complete information about their current job profile or desired job profile, the system may generate inaccurate or incomplete recommendations. To address this limitation, the system could be enhanced with additional input validation and error-checking mechanisms.

Another limitation of the system is that it may not be able to account for external factors that could impact a user's career path, such as changes in the job market or economic conditions. To address this limitation, the system could be enhanced with additional data sources and machine learning algorithms that can account for these external factors.

Overall, the career path recommendation system has the potential to be a valuable tool for individuals who are looking to advance their careers or make a career change. With further refinement and development, the system could be an even more powerful tool for helping users to achieve their career goals
## References:books:
